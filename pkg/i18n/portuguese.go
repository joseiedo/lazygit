...
func PortugueseTranslationSet() TranslationSet {
	return TranslationSet{
		// NotEnoughSpace:                       "Not enough space to render panels",
		NotEnoughSpace:                       "Sem espaço suficiente pra renderizar os paineis",
		DiffTitle:                            "Diff",
		FilesTitle:                           "Arquivos",
		...
		LogTitle:                             "Log",
		CommitSummary:                        "Resumo do commit",
		CredentialsUsername:                  "Usuário",
		CredentialsPassword:                  "Senha",
		CredentialsPassphrase:                "Insira a frase secreta para a chave SSH",
		CredentialsPIN:                       "Insira o PIN para a chave SSH",
		PassUnameWrong:                       "Senha, frase secreta e/ou usuário errados",
		Commit:                               "Commit",
		CommitTooltip:                        "Commitar mudanças em staged.",
		AmendLastCommit:                      "Alterar último commit",
		AmendLastCommitTitle:                 "Alterar último commit",
		SureToAmend:                          "Você tem certeza de que quer alterar o último commit? Depois, você pode mudar a mensagem do commit no painel de commits.",
		NoCommitToAmend:                      "não há commits para alterar",
		CommitChangesWithEditor:              "Faça commits das mudanças usando o git editor",
		FindBaseCommitForFixup:               "Procure pelo commit base para o fixup",
		FindBaseCommitForFixupTooltip:        "Encontre o commit de onde suas mudanças atuais vieram, para evitar o trabalho de alterar/consertar o commit. Isso te poupa de ter que olhar os commits de sua branch um por um pra encontrar que commit deve ser alterado/rodar o fixed up. Veja as docs: <https://github.com/jesseduffield/lazygit/tree/master/docs/Fixup_Commits.md>",
	//NoDeletedLinesInDiff:                 "No deleted lines in diff",
		NoDeletedLinesInDiff:                 "nenhuma linha deletada em diff",
		NoBaseCommitsFound:                   "nenhum commit base encontrado",
		MultipleBaseCommitsFoundStaged:       "Multiplos commits base encontrados. (Tente adicionar menos mudanças em staging de uma vez)",
		MultipleBaseCommitsFoundUnstaged:     "Multiplos commits base encontrados. (Tente adicionar algumas mudanças em staging)",
		BaseCommitIsAlreadyOnMainBranch:      "O commit base dessa mudança já está na branch principal",
